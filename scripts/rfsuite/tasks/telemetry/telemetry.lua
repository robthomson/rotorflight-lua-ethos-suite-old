...
local sensorTable = {
    ...
    governor = {sport = {category = CATEGORY_TELEMETRY_SENSOR, appId = 0x5125},sport_alt = {category = CATEGORY_TELEMETRY_SENSOR, appId = 0x5450}, ccrsf = {category = CATEGORY_TELEMETRY_SENSOR, appId = 0x1205}, lcrsf = "Flight mode"},
    ...
    armflags = {sport = {category = CATEGORY_TELEMETRY_SENSOR, appId = 0x5122}, sport_alt = {category = CATEGORY_TELEMETRY_SENSOR, appId = 0x5462}, ccrsf = {category = CATEGORY_TELEMETRY_SENSOR, appId = 0x1202}, lcrsf = nil},
    throttlePercentage = {sport = {category = CATEGORY_TELEMETRY_SENSOR, appId = 0x51A4}, sport_alt = {category = CATEGORY_TELEMETRY_SENSOR, appId = 0x5440}, ccrsf = {category = CATEGORY_TELEMETRY_SENSOR, appId = 0x1035}, lcrsf = nil},
